...
<style><%@include file="/style/main.css"%></style>
	<body>
		<div class="container">
			...
			<div class="form-group">
				<label class="col-lg-3 control-label">Мастер</label>
				<div class="col-lg-9">
			...
			<div class="form-group">
				<div class="col-lg-8 col-lg-offset-2">
					<button type="submit" class="btn btn-primary center-block" <c:if test="${isAllowedConfirm}">disabled</c:if>>Подтвердить наличие з/п</button>
				</div>
			</div>
