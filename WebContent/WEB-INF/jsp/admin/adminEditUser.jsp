...
<div class="container">
	...
	<form class="form-horizontal" name="editUserForm" method="POST" action="repairthings">
	<fieldset>
	...
	<div class="form-group">
		...
		<div class="col-lg-8">
			<input type="text" class="form-control" value="${user.phone}" name="phoneNumber" placeholder="8-xxx-xxx-xx-xx">
		</div>
	</div>
